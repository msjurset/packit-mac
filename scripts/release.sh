...
echo "==> Building PackIt v${VERSION} (build ${BUILD_NUM})..."
...
DOWNLOAD_URL="https://github.com/msjurset/packit-mac/releases/download/v${VERSION}/${DMG}"
...
<rss version="2.0" xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <channel>
    <title>PackIt</title>
    <link>https://github.com/msjurset/packit-mac</link>
    <description>PackIt app updates</description>
...
gh release create "v${VERSION}" "${DMG}" \
    --title "PackIt v${VERSION}" \
    --notes "PackIt v${VERSION}

Download the DMG, open it, and drag PackIt to Applications.
Existing installations will be notified of this update automatically."

echo ""
echo "==> Release v${VERSION} complete!"
echo "    DMG: ${DMG}"
echo "    GitHub: https://github.com/msjurset/packit-mac/releases/tag/v${VERSION}"
echo "    Appcast: https://raw.githubusercontent.com/msjurset/packit-mac/main/appcast.xml"
